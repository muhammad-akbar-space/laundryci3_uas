            ...
            <div class="col-md-10 col-lg-8">
                <div class="tambah-card">
                    <div class="tambah-header">
                        <h4>✨ Tambah Data Transaksi Laundry ✨</h4>
                        <small>Isi formulir dengan lengkap dan benar</small>
                    </div>
                        ...
                        <form action="" method="post">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?= form_error('nama_mahasiswa') ? 'is-invalid' : ''; ?>"
                                            id="nama_mahasiswa" name="nama_mahasiswa" value="<?= set_value('nama_mahasiswa'); ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?= form_error('kamar') ? 'is-invalid' : ''; ?>"
                                            id="kamar" name="kamar" placeholder="Contoh: A101" value="<?= set_value('kamar'); ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?= form_error('no_hp') ? 'is-invalid' : ''; ?>"
                                            id="no_hp" name="no_hp" placeholder="08xxxxxxxxxx" value="<?= set_value('no_hp'); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control <?= form_error('jenis_layanan') ? 'is-invalid' : ''; ?>"
                                    ...
                                    <option value="Cuci Kering" data-harga="5000" <?= set_select('jenis_layanan', 'Cuci Kering'); ?>>Cuci Kering - Rp 5.000/kg</option>
                                    <option value="Cuci Setrika" data-harga="7000" <?= set_select('jenis_layanan', 'Cuci Setrika'); ?>>Cuci Setrika - Rp 7.000/kg</option>
                                    <option value="Setrika Saja" data-harga="6000" <?= set_select('jenis_layanan', 'Setrika Saja'); ?>>Setrika Saja - Rp 6.000/kg</option>
                                </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="harga_per_kg" name="harga_per_kg" readonly value="<?= set_value('harga_per_kg'); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control <?= form_error('berat_kg') ? 'is-invalid' : ''; ?>"
                                            id="berat_kg" name="berat_kg" step="0.1" min="0" value="<?= set_value('berat_kg'); ?>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="total_harga" name="total_harga" readonly value="<?= set_value('total_harga'); ?>">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <select class="form-control" id="tgl_masuk" name="tgl_masuk">
                                                ...
                                                <?php for ($i = 1; $i <= 31; $i++): ?>
                                                    <option value="<?= str_pad($i, 2, '0', STR_PAD_LEFT); ?>" <?= set_select('tgl_masuk', str_pad($i, 2, '0', STR_PAD_LEFT)); ?>><?= $i; ?></option>
                                                <?php endfor; ?>
                                            </select>
                                        </div>
                                        <div class="col-md-4">
                                            <select class="form-control" id="bln_masuk" name="bln_masuk">
                                                ...
                                                <option value="01" <?= set_select('bln_masuk', '01'); ?>>Januari</option>
                                                <option value="02" <?= set_select('bln_masuk', '02'); ?>>Februari</option>
                                                <option value="03" <?= set_select('bln_masuk', '03'); ?>>Maret</option>
                                                <option value="04" <?= set_select('bln_masuk', '04'); ?>>April</option>
                                                <option value="05" <?= set_select('bln_masuk', '05'); ?>>Mei</option>
                                                <option value="06" <?= set_select('bln_masuk', '06'); ?>>Juni</option>
                                                <option value="07" <?= set_select('bln_masuk', '07'); ?>>Juli</option>
                                                <option value="08" <?= set_select('bln_masuk', '08'); ?>>Agustus</option>
                                                <option value="09" <?= set_select('bln_masuk', '09'); ?>>September</option>
                                                <option value="10" <?= set_select('bln_masuk', '10'); ?>>Oktober</option>
                                                <option value="11" <?= set_select('bln_masuk', '11'); ?>>November</option>
                                                <option value="12" <?= set_select('bln_masuk', '12'); ?>>Desember</option>
                                            </select>
                                        </div>
                                        <div class="col-md-4">
                                            <select class="form-control" id="thn_masuk" name="thn_masuk">
                                                ...
                                                <?php for ($i = 2024; $i <= 2030; $i++): ?>
                                                    <option value="<?= $i; ?>" <?= set_select('thn_masuk', $i); ?>><?= $i; ?></option>
                                                <?php endfor; ?>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <input type="hidden" id="tanggal_masuk" name="tanggal_masuk" value="<?= set_value('tanggal_masuk'); ?>">
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <select class="form-control" id="tgl_selesai" name="tgl_selesai">
                                                <option value="">Tanggal</option>
                                                <?php for ($i = 1; $i <= 31; $i++): ?>
                                                    <option value="<?= str_pad($i, 2, '0', STR_PAD_LEFT); ?>" <?= set_select('tgl_selesai', str_pad($i, 2, '0', STR_PAD_LEFT)); ?>><?= $i; ?></option>
                                                <?php endfor; ?>
                                            </select>
                                        </div>
                                        <div class="col-md-4">
                                            <select class="form-control" id="bln_selesai" name="bln_selesai">
                                                <option value="">Bulan</option>
                                                <option value="01" <?= set_select('bln_selesai', '01'); ?>>Januari</option>
                                                <option value="02" <?= set_select('bln_selesai', '02'); ?>>Februari</option>
                                                <option value="03" <?= set_select('bln_selesai', '03'); ?>>Maret</option>
                                                <option value="04" <?= set_select('bln_selesai', '04'); ?>>April</option>
                                                <option value="05" <?= set_select('bln_selesai', '05'); ?>>Mei</option>
                                                <option value="06" <?= set_select('bln_selesai', '06'); ?>>Juni</option>
                                                <option value="07" <?= set_select('bln_selesai', '07'); ?>>Juli</option>
                                                <option value="08" <?= set_select('bln_selesai', '08'); ?>>Agustus</option>
                                                <option value="09" <?= set_select('bln_selesai', '09'); ?>>September</option>
                                                <option value="10" <?= set_select('bln_selesai', '10'); ?>>Oktober</option>
                                                <option value="11" <?= set_select('bln_selesai', '11'); ?>>November</option>
                                                <option value="12" <?= set_select('bln_selesai', '12'); ?>>Desember</option>
                                            </select>
                                        </div>
                                        <div class="col-md-4">
                                            <select class="form-control" id="thn_selesai" name="thn_selesai">
                                                <option value="">Tahun</option>
                                                <?php for ($i = 2024; $i <= 2030; $i++): ?>
                                                    <option value="<?= $i; ?>" <?= set_select('thn_selesai', $i); ?>><?= $i; ?></option>
                                                <?php endfor; ?>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <input type="hidden" id="tanggal_selesai" name="tanggal_selesai" value="<?= set_value('tanggal_selesai'); ?>">
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control <?= form_error('status') ? 'is-invalid' : ''; ?>"
                                            ...
                                            <option value="Diambil" <?= set_select('status', 'Diambil'); ?>>Diambil</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control <?= form_error('metode_pembayaran') ? 'is-invalid' : ''; ?>"
                                            ...
                                            <option value="QRIS" <?= set_select('metode_pembayaran', 'QRIS'); ?>>QRIS</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="tanggal_pembayaran" name="tanggal_pembayaran" value="<?= set_value('tanggal_pembayaran'); ?>">
                            </div>

                            <!-- Catatan -->
                            <div class="form-group">
                                <label for="catatan">📝 Catatan</label>
                                <textarea class="form-control" id="catatan" name="catatan" rows="3" placeholder="Catatan tambahan (opsional)"><?= set_value('catatan'); ?></textarea>
                            </div>

                            <!-- Buttons -->
                            <div class="text-center mt-4">
                                <button type="submit" class="btn btn-tambah">💾 Tambah Data</button>
